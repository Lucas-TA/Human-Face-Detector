...
class Register extends Component {
    ...
    onSubmitRegister = () => {
        fetch('https://facerecognition-app-server-d0df9a15e40b.herokuapp.com/register', {
            method: 'post',
    ...
    render() {
        return (
        <article className="br3 ba custom-bg mt4 b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
